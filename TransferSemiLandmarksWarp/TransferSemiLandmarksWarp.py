...
import csv
#
# TransferSemiLandmarksWarp
#

class TransferSemiLandmarksWarp(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "TransferSemiLandmarksWarp" # TODO make this more human readable by adding spaces
...
#
# TransferSemiLandmarksWarpWidget
#

class TransferSemiLandmarksWarpWidget(ScriptedLoadableModuleWidget):
  ...
  def setup(self):
    ...
    self.applyButton.toolTip = "Generate TransferSemiLandmarksWarps."
  ...
  def onApplyButton(self):
    logic = TransferSemiLandmarksWarpLogic()
...
#
# TransferSemiLandmarksWarpLogic
#

class TransferSemiLandmarksWarpLogic(ScriptedLoadableModuleLogic):
...
class TransferSemiLandmarksWarpTest(ScriptedLoadableModuleTest):
  """
  ...
  def runTest(self):
    """Run as few or as many tests as needed here.
      """
    self.setUp()
    self.test_TransferSemiLandmarksWarp1()
  
  def test_TransferSemiLandmarksWarp1(self):
