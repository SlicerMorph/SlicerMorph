...
### Utility Modules 
  ...
  - [**MergeMarkups:**](https://github.com/SlicerMorph/SlicerMorph/tree/master/Docs/MergeCurves). A utility to tag and consolidate fixed and semiLM files into a single merged file.
