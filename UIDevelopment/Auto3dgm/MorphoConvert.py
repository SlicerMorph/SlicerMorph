...
class MorphoConvert(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "MorphoConvert" # TODO make this more human readable by adding spaces
...
class MorphoConvertWidget(ScriptedLoadableModuleWidget):
...
class MorphoConvertLogic(ScriptedLoadableModuleLogic):
...
class MorphoConvertTest(ScriptedLoadableModuleTest):
  """
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_MorphoConvert1()

  def test_MorphoConvert1(self):
